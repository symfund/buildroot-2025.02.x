...
ARM_TRUSTED_FIRMWARE_MAKE_OPTS += SCP_BL2=$(BINARIES_DIR)/$(BR2_TARGET_ARM_TRUSTED_FIRMWARE_SCP_URL)
ARM_TRUSTED_FIRMWARE_MAKE_ENV += NEED_SCP_BL2=yes
...
ARM_TRUSTED_FIRMWARE_MAKE_OPTS += LDFLAGS='--no-warn-rwx-segments'
